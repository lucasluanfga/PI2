...
// Mostrando os valores pelo monitor serial
  ...
  pinMode(D0, INPUT); //setando pino de calibração como entrada para receber o nível lógico da raspberry
  if (digitalRead(D0) == HIGH){ // se em nivel logico alto, inicia a calibração
